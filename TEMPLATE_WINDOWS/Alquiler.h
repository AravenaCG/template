...
#endif// _ALQUILER_H
#define ALQUILER_ACTIVO 1
#define ALQUILER_INACTIVO 0
#define ARCHIVO_ALQUILERES "Alquileres.txt"

Alquiler* alquiler_new(int idCliente,int idEquipo,int tiempoEstimado,int tiempoReal,int idAlquiler,int estado);
